...
public class MainFunction {
	...
	public static void main ( String[] args ) throws FileNotFoundException {
		...
		String input = dir + "test1000g5"+".gml"; //input graph, please prepare your data in the GML format
		FileOutputStream output = null;
		String out = dir.concat("test1000g5Output24.1.21"); //name your output file
